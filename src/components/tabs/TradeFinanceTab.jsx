                ...
                <table className="w-full border-collapse text-xs border border-gray-300">
                    <thead>
                        <tr className="bg-slate-900">
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 sticky left-0 z-10 bg-slate-900">Deal Date</th>
                            ...
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">LC Establishment Date</th>
                            ...
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Account A</th>
                            ...
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Account B</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Source Of Funds</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Currency</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Amount</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Fee/Refund Accs</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Source Of Funds</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Fee/Refund Curre</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Fee/Refund/Fx</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Fee/Refund Accoun</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Source Of Funds</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Fee/Refund Currency</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Fee/Refund/Fx Pnl</th>
                            <th className="text-left text-xs font-medium text-white p-2 border border-slate-800 bg-slate-900">Settlement Status</th>
